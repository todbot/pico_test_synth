...
* [`synthtools_polysynth`](synthtools_polysynth/) - 16-pad chromatic polysynth based on `SubtractiveSynth`, 18 parameters grouped into 6 named sections, two pots per pair
